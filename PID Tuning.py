...
gains = {
    'AoA':     {'kp': 5, 'ki': 0.1, 'kd':0.8},
    'sideslip':{'kp': 5, 'ki': 0.1, 'kd': 1.2},
    'roll':    {'kp': 5, 'ki': 0.1, 'kd': 1},
    'speed':   {'kp': 80, 'ki': 0.8, 'kd': 0}
}
...
def PID_Control(action):
    ...
    commands = {
        ...
        'throttle' : np.clip(outputs['speed'] / 343, 0.0, 1.0)          # [0, 1]
    }
...
aircraft = FixedWingAircraft(config['uav_config'], config['env_config']['rho'],
